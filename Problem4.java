...
Input
The first line of input contains a single positive integer  indicating the number of test cases. The first line of each test case also contains a single positive integer  indicating the number of work trips Alice has taken so far. The following  lines describe these trips. The th such line simply contains the name of the city Alice visited on her th trip.
...
The number of trips is at most  and no city name contains more than  characters.
