...
Most annoyingly though, he almost never has any money, 
so his only obvious legal way to obtain more soda is to take the money he gets when he recycles 
empty soda bottles to buy new ones. In addition to the empty bottles resulting 
from his own consumption he sometimes find empty bottles in the street. 
...
public class Problem3 {
    public static int sodaAnswer(int e, int f, int c){
        ...
        sodasBought = (e + f) / c;
        leftoverBottles = ((e + f) % c) + sodasBought;
        sodasDrank += sodasBought; 

        while (leftoverBottles >= c) {
            sodasBought = (leftoverBottles / c);
            leftoverBottles = (leftoverBottles % c) + sodasBought;
            sodasDrank += sodasBought; 
        }
